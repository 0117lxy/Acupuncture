Shader "Unlit/P_AncientCartoonSkin"
{
    Properties{
        _Color ("色调", Color)=(1,1,1,1)
		_MainTex ("颜色贴图", 2D)="white"{}
		_Ramp ("渐变纹理", 2D)="white"{}
		_Outline ("轮廓线宽度",Range(0,1))=0.1
		_OutlineColor ("轮廓线颜色",Color)=(0,0,0,1)
		_Specular ("高光反射颜色",Color)=(1,1,1,1)
		_SpecularScale ("高光反射阈值",Range(0,1))=0.01
        _OutLineTex("外轮廓贴图",2D)="gray"
    }
    SubShader{
        Tags {
            "RenderType"="Opaque" 
        ...
        Pass{
            ...
            fixed4 frag (v2f i) :SV_Target{
                fixed4 outlineColor=_OutlineColor*tex2D(_OutLineTex,i.uv);
